...
You can install the latest pre-built binary from [releases](https://github.com/fangen/kalamarnica/releases).
...
```bash
git clone https://github.com/fangen/kalamarnica.git
cd kalamarnica
cargo build --release
```
